...
describe('reactivity', async () => {
  ...
  describe('local storage', () => {
    ...
    it('should react to changes', async () => {
      const { getByTestId } = render(() => <ReactiveQueries reactive={true} databaseOptions={{ localStorage: true }} />)
    ...
    it('should react to changes when initialized from local storage', async () => {
      const { getByTestId } = render(() => <ReactiveQueries reactive={true} initFromLocalStorage={true} databaseOptions={{ localStorage: true }} />)
