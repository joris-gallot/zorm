...
export function setup({ reactive, initFromLocalStorage = false, databaseOptions }: { reactive: boolean, initFromLocalStorage?: boolean, databaseOptions?: SvelteDatabaseOptions }) {
